...
tags:
  ...
  - stub-factory
triggers:
  - "how to create test doubles for unit tests"
  - "mock vs stub vs fake strategy"
  - "StubFactory usage and generation"
  - "TDD workflow with test cases JSON"
summary: "3-layer test double strategy (Stub JSON, Mock, Fake) with TDD test case definitions as source of truth"
version: "1.0"
status: active
created: "2026-02-02"
updated: "2026-02-22"
