Pod::Spec.new do |spec|
  ...
  if msp_release
    ...
    spec.vendored_frameworks = "Binary/MintegralAdapter.xcframework"
  else
    # DEVELOPMENT MODE: Source files for internal development
    spec.source = { :path => '.' }
    spec.source_files = "Sources/Adapters/MintegralAdapter/MintegralAdapter/**/*.{swift}"
  end
  ...
  spec.dependency 'MintegralAdSDK/BidRewardVideoAd'
