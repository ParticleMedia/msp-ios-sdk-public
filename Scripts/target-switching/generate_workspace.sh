...
# NOTE: Info.plist generation is handled by switch-target.sh, NOT here.
# This ensures a single source of truth for plist generation.
# switch-target.sh copies Info.plist.template → Info.plist for BOTH modes.
