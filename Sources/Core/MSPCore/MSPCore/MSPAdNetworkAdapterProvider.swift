...
@MainActor
 public func prepareViewForInteraction(nativeAd: NativeAd, nativeAdView: Any) {
    ...
    public func loadAdCreative(
        ...
        adRequest: AdRequest, bidderPlacementId: String
    ) {
    }

    public func initialize(
        initParams: InitializationParameters, adapterInitListener: any AdapterInitListener, context: Any?
    ) {
    }
