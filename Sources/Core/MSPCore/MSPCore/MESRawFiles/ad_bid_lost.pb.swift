...
// Source: mes_events/ad_bid_lost.proto
//
...
struct Com_Newsbreak_Mes_Events_AdBidLostEvent: @unchecked Sendable {
  ...
  var winnerBidderName: String {
    get {return _storage._winnerBidderName}
    set {_uniqueStorage()._winnerBidderName = newValue}
  }

  var winnerPrice: Float {
    get {return _storage._winnerPrice}
    set {_uniqueStorage()._winnerPrice = newValue}
  }
...
extension Com_Newsbreak_Mes_Events_AdBidLostEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AdBidLostEvent"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    8: .standard(proto: "winner_bidder_name"),
    9: .standard(proto: "winner_price"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _winnerBidderName: String = String()
    var _winnerPrice: Float = 0
    ...
    init(copying source: _StorageClass) {
      ...
      _winnerBidderName = source._winnerBidderName
      _winnerPrice = source._winnerPrice
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 8: try { try decoder.decodeSingularStringField(value: &_storage._winnerBidderName) }()
        case 9: try { try decoder.decodeSingularFloatField(value: &_storage._winnerPrice) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._winnerBidderName.isEmpty {
        try visitor.visitSingularStringField(value: _storage._winnerBidderName, fieldNumber: 8)
      }
      if _storage._winnerPrice.bitPattern != 0 {
        try visitor.visitSingularFloatField(value: _storage._winnerPrice, fieldNumber: 9)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Com_Newsbreak_Mes_Events_AdBidLostEvent, rhs: Com_Newsbreak_Mes_Events_AdBidLostEvent) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._winnerBidderName != rhs_storage._winnerBidderName {return false}
        if _storage._winnerPrice != rhs_storage._winnerPrice {return false}
        return true
      }
