...
// Source: mes_events/ad_dismiss.proto
//
...
struct Com_Newsbreak_Mes_Events_AdDismissEvent: @unchecked Sendable {
...
extension Com_Newsbreak_Mes_Events_AdDismissEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AdDismissEvent"
  ...
  static func ==(lhs: Com_Newsbreak_Mes_Events_AdDismissEvent, rhs: Com_Newsbreak_Mes_Events_AdDismissEvent) -> Bool {
