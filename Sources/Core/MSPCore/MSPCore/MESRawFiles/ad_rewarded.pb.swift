...
// Source: mes_events/ad_rewarded.proto
//
...
struct Com_Newsbreak_Mes_Events_AdRewardedEvent: @unchecked Sendable {
...
extension Com_Newsbreak_Mes_Events_AdRewardedEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AdRewardedEvent"
  ...
  static func ==(lhs: Com_Newsbreak_Mes_Events_AdRewardedEvent, rhs: Com_Newsbreak_Mes_Events_AdRewardedEvent) -> Bool {
