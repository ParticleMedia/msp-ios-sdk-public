...
public class AdMetricReporterImp: AdMetricReporter {
    public func logAdHide(
        ...
        MESMetricReporter.shared.logAdHide(
            ad: ad, adRequest: adRequest, bidResponse: bidResponse, reason: reason, adScreenshot: adScreenShot,
    ...
    public func logAdReport(
        ...
        MESMetricReporter.shared.logAdReport(
            ad: ad, adRequest: adRequest, bidResponse: bidResponse, reason: reason, description: description,
    ...
    public func logAdClick(ad: MSPAd, adRequest: AdRequest, bidResponse: Any?, clickMetadata: AdClickMetadata?) {
        MESMetricReporter.shared.logAdClick(
            ad: ad,
            adRequest: adRequest,
