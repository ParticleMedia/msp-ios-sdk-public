Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.92"
  spec.summary      = "an adapter for Unity SDK"
  spec.description  = "an adapter for Unity SDK for MSP S2S"
  spec.homepage     = "https://github.com/aimsp/msp-ios-sdk/UnityAdapter"
  ...
  if msp_release
    ...
    spec.vendored_frameworks = "Binary/UnityAdapter.xcframework"
  else
    # DEVELOPMENT MODE: Source files for internal development
    spec.source = { :path => '.' }
    spec.source_files = "Sources/Adapters/UnityAdapter/UnityAdapter/**/*.{swift}"
  end
