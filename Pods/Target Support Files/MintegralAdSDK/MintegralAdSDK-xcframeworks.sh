...
{
  case "$1" in
  "MTGSDKBanner.xcframework/ios-arm64")
    echo ""
    ;;
  "MTGSDKBanner.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "MTGSDKBidding.xcframework/ios-arm64")
    echo ""
    ;;
  ...
  "MTGSDKInterstitialVideo.xcframework/ios-arm64")
    echo ""
    ;;
  "MTGSDKInterstitialVideo.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "MTGSDK.xcframework/ios-arm64")
    echo ""
    ;;
  "MTGSDK.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "MTGSDKNewInterstitial.xcframework/ios-arm64")
    echo ""
    ;;
  "MTGSDKNewInterstitial.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  esac
}
...
install_xcframework "${PODS_ROOT}/MintegralAdSDK/Fmk/MTGSDKNewInterstitial.xcframework" "MintegralAdSDK/NewInterstitialAd" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
