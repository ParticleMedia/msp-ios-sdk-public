...
public class DemoNativeAdContainer: UIView, MSPNativeAdContainer {
    let titleLabel: UILabel = {
        ...
        label.textColor = UIColor(
            light: UIColor(hex: "000000")!.withAlphaComponent(0.9),
            dark: UIColor(hex: "FFFFFF")!.withAlphaComponent(0.85))
    ...
    let advertiserLabel: UILabel = {
        ...
        label.textColor = UIColor(
            light: UIColor(hex: "000000")!.withAlphaComponent(0.3),
            dark: UIColor(hex: "FFFFFF")!.withAlphaComponent(0.6))
